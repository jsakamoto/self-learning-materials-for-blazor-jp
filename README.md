...
本稿執筆時点での Blazor WebAssembly (client-side) 版 Blazor は v.3.2.0 Preview 45 であり、正式リリースは 2020 年5月が予定されています。
...
また、本リポジトリの [v.3.2.0-preview5.20216.8 ブランチ](https://github.com/jsakamoto/self-learning-materials-for-blazor-jp/commits/v.3.2.0-preview5.20216.8)には、自習書テキストで解説している1ステップを 1コミットとして履歴を記録したソースコードも収録してあります。
...
- [Visual Studio 2019 - 16.6.0 Preview 4 以降](https://visualstudio.microsoft.com/vs/preview/)
    - "ASP.NET と Web 開発" ワークロードが選択されていること
- 以上の環境をインストールし利用可能な Windows OS

なお、本自習書では Windows OS 上で Visual Studio 2019 16.6.0 Preview 4 以降を使っての手順で説明しておりますが、Blazor アプリ開発にあたっては、最低限、 
...
特にテキストエディタとして、**Visual Studio Code** を用い、これに **["C# for Visual Studio Code" 拡張 v.1.21以上](https://marketplace.visualstudio.com/items?itemName=ms-vscode.csharp)** をインストールして使用する場合は、本自習書で説明しているような Visual Studio 2019 と同等の開発支援が得られます。
 ...
 本自習書では Windows OS 上で Visual Studio 2019 16.6 Preview 4 以降を使っての手順で説明します。
